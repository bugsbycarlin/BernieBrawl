...
local speed_line_max_height = 24
...
function effects:create(top_level_group, foreground_group)
  ...
  function object:addRedSpeedLine(y, group)
  ...
  function object:removeType(type_string)
    copy_effect_list = {}
    for i = 1, #self.effect_list do
  ...
  function object:addTemporaryText(text_string, x, y, font_size, color, group, duration)
    text = {}
  ...
  function object:shakeScreen(intensity, duration)
    local shake = {}
  ...
  function object:addDizzyTwit(group, originator, x_center, y_center, width, duration)
  ...
  function object:addProjectileTwit(group, originator, x, y, z, xScale)
  ...
  function object:addProjectileSteak(group, originator, x, y, z, xScale)
  ...
  function object:addProjectileGoldBar(group, originator, x, y, z, xScale)
  ...
  function object:addProjectilePhone(group, originator, x, y, z, xScale)
  ...
  function object:addProjectileSoda(group, originator, x, y, z, xScale)
  ...
  function object:addBro(group, player, x_center, y_center, x_vel, y_vel, min_x, max_x, min_z, max_z)
  ...
  function object:randomSwing()
    audio.play(sounds["swing_" .. math.random(1,3)], 0)
  end

  function object:randomDamageSound()
